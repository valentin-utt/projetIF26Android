                    ...
                    public void onCreate(@NonNull SupportSQLiteDatabase db) {
                        ...
                        Executors.newSingleThreadScheduledExecutor().execute(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Cache cache2 = new Cache(-110,37.0042454,2,1 ,1, 10,1 ,"Rien", "C'est magique");
                                Cache cache3 = new Cache(40.730610,-73.935242,3,1 ,1, 16,1 ,"Tout en haut", "la merveille du monde");
                                Cache cache4 = new Cache(48.636,-1.5114,1,1 ,1, 15,1 ,"A droite du banc", "C'est top");
                                Cache cache5 = new Cache(12.496366,41.902784,2,3 ,1, 30,1 ,"A gauche du container", "un coffre extra");
                                Cache cache6 = new Cache(45,2,3,2 ,1, 25,1 ,"Tout en haut", "la merveille du monde");
                                Cache cache7 = new Cache(45,-2,1,2 ,1, 2,1 ,"A droite du banc", "C'est top");
                                Cache cache8 = new Cache(50,3,2,1 ,2, 14,1 ,"A gauche du container", "incroyable");
